...
export class ListaPropietariosComponent implements OnInit {
  ...
  columns: TableColumn<any>[] = [
    { label: 'Modelo', property: 'razonSocial', type: 'text', visible: true, cssClasses: ['font-medium'] },
    { label: 'Fabricante', property: 'rfc', type: 'text', visible: true, cssClasses: ['font-medium'] },
    { label: 'Proveedor', property: 'direccion', type: 'text', visible: true, cssClasses: ['font-medium'] },
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.dataSourceOriginal = [
      {
        id: 1,
        razonSocial: 'HP 15-EF2024NR',
        rfc: 'HP',
        direccion: 'Amazon '
      },
      {
        id: 4,
        razonSocial: 'X515JA-EJ2558W',
        rfc: 'ASUS',
        direccion: 'Amazon'
      },
      {
        id: 6,
        razonSocial: 'Ideapad 5-14ARE05',
        rfc: 'Lenovo',
        direccion: 'Amazon'
      }];
